...
class Toolbar extends Component {
    ...
    render() {
        ...
        const openId = editor.get('id')
        const hideSave = !openId || openId == 'help'
        const hideRemove = !openId || openId == 'config' || openId == 'help'
        return (
            <ul id="right">
                ...
                <li><button className={classNames('button', 'button-circle', 'remove', {hide: hideRemove})} onFocus={() => this.showConfirm(true)} onBlur={() => this.showConfirm(false)}><i className="fa fa-trash"></i></button></li>
